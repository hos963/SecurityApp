...
class UnLockQuestionareModel {
  ...
  factory UnLockQuestionareModel.fromJson(Map<String, dynamic> parsedJson) {
    return UnLockQuestionareModel(
      ...
      unlockandunalarmed:parsedJson['unlockandunalarmed'],
  ...
  Map<String ,dynamic>  AddUnLockOnthewayToMap(){
  ...
  Map<String ,dynamic>  AlarmedAndSecured(){
    Map<String,dynamic> map = new Map();
    Map<String,dynamic> onallmapp = new Map();
    onallmapp["unlockandunalarmed"] =  unlockandunalarmed;
    map['QuestionareModel'] =onallmapp;
