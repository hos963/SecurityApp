                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      icon: Padding(
                        ...
                        child: Icon(Icons.location_city, color: CustomColors.orangecolor),
                      ),
                      hintText: 'Address',
              ...
              Material(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      icon: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Icon(Icons.gps_fixed, color: CustomColors.orangecolor),
                      ),
                      hintText: 'Latitude',
...
elevation: 8.0,
  ...
  void _createUSerAccount() {
    if (!_addressController.text.isEmpty &&
      ...
      AddressAlarmModel addressAlarmModel = new AddressAlarmModel(locationName: _addressController.text,latitude: _latController.text,longitude: _LongiController.text);
