...
class ReportAlarmPage extends StatefulWidget {
  @override
  _ReportAlarmPagePageState createState() => _ReportAlarmPagePageState();
}

class _ReportAlarmPagePageState extends State<ReportAlarmPage> {
