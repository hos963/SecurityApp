...
class Take4thImageOfkeys extends StatefulWidget {

  final MyCallbackToback callback;

  AddPatrolModel addPatrolModel;
  Take4thImageOfkeys(this.addPatrolModel,this.callback);



  @override
  _Take4thImageOfkeysState createState() => _Take4thImageOfkeysState();
}

class _Take4thImageOfkeysState extends State<Take4thImageOfkeys> {
  @override
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take 4th Picture of keys", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    Take4thPictureOfKey takePictureOfBuildingModel =
    new Take4thPictureOfKey();
    takePictureOfBuildingModel.taker4thPictureOfKeys = ImgLinnk;
    widget.addPatrolModel.questionareModel.taker4thPictureOfKeys =
        takePictureOfBuildingModel;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.Take4thPictureOfKey(widget.addPatrolModel.patrolId,
