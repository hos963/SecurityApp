...
class Take2ndImageOfKeys extends StatefulWidget {

  final MyCallbackToback callback;

  AddPatrolModel addPatrolModel;
  Take2ndImageOfKeys(this.addPatrolModel,this.callback);

  @override
  _Take2ndImageOfKeysState createState() => _Take2ndImageOfKeysState();
}

class _Take2ndImageOfKeysState extends State<Take2ndImageOfKeys> {
  File _image;
      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              SizedBox(height: 20),
              text("Take 2nd Picture of key", textColor: quiz_textColorPrimary,
                  isLongText: true,
                  isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    Take2ndPictureOfKey takePictureOfBuildingModel =
    new Take2ndPictureOfKey();
    takePictureOfBuildingModel.take2ndPictureOfKeys = ImgLinnk;
    widget.addPatrolModel.questionareModel.take2ndPictureOfKeys =
        takePictureOfBuildingModel;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.Take2ndPictureOfKey(widget.addPatrolModel.patrolId,
