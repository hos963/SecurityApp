...
class Take3rdImageOfKeys extends StatefulWidget {

  final MyCallbackToback callback;

  AddPatrolModel addPatrolModel;
  Take3rdImageOfKeys(this.addPatrolModel,this.callback);


  @override
  _Take3rdImageOfKeysState createState() => _Take3rdImageOfKeysState();
}

class _Take3rdImageOfKeysState extends State<Take3rdImageOfKeys> {
  @override
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take 3rd Picture of keys", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    Take3rdPictureOfKey takePictureOfBuildingModel =
    new Take3rdPictureOfKey();
    takePictureOfBuildingModel.take3rdPictureOfKeys = ImgLinnk;
    widget.addPatrolModel.questionareModel.take3rdPictureOfKeys =
        takePictureOfBuildingModel;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.Take3rdPictureOfKey(widget.addPatrolModel.patrolId,
