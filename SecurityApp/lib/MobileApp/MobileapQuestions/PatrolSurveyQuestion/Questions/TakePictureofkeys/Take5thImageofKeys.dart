...
class Take5thImageofKeys extends StatefulWidget {


  final MyCallbackToback callback;

  AddPatrolModel addPatrolModel;
  Take5thImageofKeys(this.addPatrolModel,this.callback);



  @override
  _Take5thImageofKeysState createState() => _Take5thImageofKeysState();
}

class _Take5thImageofKeysState extends State<Take5thImageofKeys> {
  @override
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take 5th Picture of keys", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    Take5thPictureOfKey takePictureOfBuildingModel =
    new Take5thPictureOfKey();
    takePictureOfBuildingModel.taker5thPictureOfKeys = ImgLinnk;
    widget.addPatrolModel.questionareModel.taker5thPictureOfKeys =
        takePictureOfBuildingModel;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.Take5thPictureOfKey(widget.addPatrolModel.patrolId,
