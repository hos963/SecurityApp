...
class TakeFourthInternalPictures extends StatefulWidget {

  final MyCallbackToback callback;

  AddPatrolModel addPatrolModel;
  TakeFourthInternalPictures(this.addPatrolModel,this.callback);

  @override
  _TakeInternalPicturesState createState() => _TakeInternalPicturesState();
}

class _TakeInternalPicturesState extends State<TakeFourthInternalPictures> {
  File _image;
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take 4th Internal Pictures", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    InternalThirdPictureOfBuildingModel takePictureOfBuildingModel =
    new InternalThirdPictureOfBuildingModel();
    takePictureOfBuildingModel.internalbuildingpic = ImgLinnk;
    widget.addPatrolModel.questionareModel.internalThirdPictureOfBuildingModel =
        takePictureOfBuildingModel;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.TakeThirdInternalPicture(widget.addPatrolModel.patrolId,
