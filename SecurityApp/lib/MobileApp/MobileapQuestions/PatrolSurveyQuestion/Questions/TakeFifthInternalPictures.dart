...
class _TakeInternalPicturesState extends State<TakeFifthInternalPictures> {
  File _image;
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take 5th Internal Pictures", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    InternalFourthPictureOfBuildingModel takePictureOfBuildingModel =
    new InternalFourthPictureOfBuildingModel();
    takePictureOfBuildingModel.internalbuildingpic = ImgLinnk;
    widget.addPatrolModel.questionareModel.internalFourthPictureOfBuildingModel =
        takePictureOfBuildingModel;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.TakeFourthInternalPicture(widget.addPatrolModel.patrolId,
