...
class Take2ndPicture extends StatefulWidget {

  final MyCallbackToback callback;
  AddPatrolModel addPatrolModel;
  Take2ndPicture(this.addPatrolModel,this.callback);


  @override
  _Take2ndPictureState createState() => _Take2ndPictureState();
}

class _Take2ndPictureState extends State<Take2ndPicture> {
  File _image;
