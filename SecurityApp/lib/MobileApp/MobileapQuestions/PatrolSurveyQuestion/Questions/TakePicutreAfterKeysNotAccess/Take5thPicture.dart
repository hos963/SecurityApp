...
class Take5thPicture extends StatefulWidget {

  final MyCallbackToback callback;
  AddPatrolModel addPatrolModel;
  Take5thPicture(this.addPatrolModel,this.callback);


  @override
  _Take5thPictureState createState() => _Take5thPictureState();
}

class _Take5thPictureState extends State<Take5thPicture> {
  File _image;
