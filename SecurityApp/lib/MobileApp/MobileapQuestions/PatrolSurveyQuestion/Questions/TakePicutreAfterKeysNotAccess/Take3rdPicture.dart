...
class Take3rdPicture extends StatefulWidget {

  final MyCallbackToback callback;

  AddPatrolModel addPatrolModel;
  Take3rdPicture(this.addPatrolModel,this.callback);


  @override
  _Take3rdPictureState createState() => _Take3rdPictureState();
}

class _Take3rdPictureState extends State<Take3rdPicture> {
  File _image;
