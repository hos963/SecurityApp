...
class Take1stPicture extends StatefulWidget {
  ...
  Take1stPicture(this.addPatrolModel,this.callback);


  @override
  _Take1stPictureState createState() => _Take1stPictureState();
}

class _Take1stPictureState extends State<Take1stPicture> {
  File _image;
