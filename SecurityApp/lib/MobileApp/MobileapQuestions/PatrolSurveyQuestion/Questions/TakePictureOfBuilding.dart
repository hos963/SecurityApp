...
class TakePictureOfBuilding extends StatefulWidget {

  final MyCallbackToback callback;

  AddPatrolModel addPatrolModel;
  TakePictureOfBuilding(this.addPatrolModel,this.callback);

  @override
  _TakePictureOfBuildingState createState() => _TakePictureOfBuildingState();
}

class _TakePictureOfBuildingState extends State<TakePictureOfBuilding> {
  File _image;
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take 5 picture of Building", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
