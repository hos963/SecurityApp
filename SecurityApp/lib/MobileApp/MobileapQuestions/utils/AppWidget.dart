...
import 'package:Metropolitane/MobileApp/MobileapQuestions/model/ListModels.dart';
import 'package:Metropolitane/MobileApp/MobileapQuestions/Screens/ProkitScreenListing.dart';
import 'package:Metropolitane/MobileApp/MobileapQuestions/utils/flix_constants.dart';
...
Text headerText(var text) {
  return Text(
    text,
    maxLines: 2,
    style: TextStyle(fontFamily: fontBold, fontSize: 22, color: whiteColor),
  );
}
...
showToast(BuildContext aContext, String caption) {
  Scaffold.of(aContext).showSnackBar(SnackBar(content: text(caption, textColor: appTextColorPrimary, isCentered: true)));
}
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Column(
                                    ...
                                    children: <Widget>[
                                      text('${widget.list[index].name}', textColor: appTextColorPrimary, fontFamily: fontMedium, fontSize: textSizeMedium, maxLine: 2),
                                      text(widget.list[index].title_name.validate(), textColor: appTextColorPrimary, fontFamily: fontRegular, fontSize: textSizeSmall)
                                  ...
                                  Container(
                                    ...
                                    child: text(widget.list[index].type, fontSize: textSizeSmall, textColor: appTextColorPrimary),
                                  )
                                ],
                              ),
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: showTrailing ? Icon(Icons.arrow_forward_ios, size: 15, color: appTextColorPrimary) : null,
      ),
    );
  }
}
