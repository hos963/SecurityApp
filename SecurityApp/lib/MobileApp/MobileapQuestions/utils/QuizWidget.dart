...
import 'package:Metropolitane/MobileApp/MobileapQuestions/utils/T8Colors.dart';
...
TextFormField quizEditTextStyle(var hintText, {isPassword = true,isenable = true}) {
...
TextFormField MultilinesEditextField(var hintText, {isPassword = true,isenable = true,controller}) {
  return TextFormField(
