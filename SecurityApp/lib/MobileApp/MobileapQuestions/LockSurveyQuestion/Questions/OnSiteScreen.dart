...
class OnSiteScreen extends StatefulWidget {
  ...
  OnSiteScreen(this.addLockModel,this.callback);
...
class _OnSiteScreenState extends State<OnSiteScreen> {
  ...
  Future<void> Updatinngdata() async {
    ...
    widget.addLockModel.questionareModel.reachedonSiteModel = reachedonSiteModel;

    FirebaseService firebaseService = new FirebaseService();
    await firebaseService.updateOnSiteLock( widget.addLockModel.lockId,widget.addLockModel.questionareModel);
