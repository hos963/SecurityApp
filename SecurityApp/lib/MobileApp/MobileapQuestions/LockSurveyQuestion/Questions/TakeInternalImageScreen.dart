...
class TakeInternalImageScreen extends StatefulWidget {
  bool isinternal;
  final MyCallbackToback callback;

  AddLockModel addLockModel;
  TakeInternalImageScreen(this.addLockModel,this.callback, {this.isinternal = true});

  @override
  _TakeInternalImageScreenState createState() => _TakeInternalImageScreenState();
}

class _TakeInternalImageScreenState extends State<TakeInternalImageScreen> {
  File _image;
      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              SizedBox(height: 20),
              text("Take Internal Picture", textColor: quiz_textColorPrimary,
                  isLongText: true,
                  isCentered: true,
                ...
                child: ProgressButton(
                  ...
                  onPressed: (AnimationController controller) {
                    if (controller.isCompleted) {
                      ...
                      controller.forward();
                      uploadFile(_image);
                      //Navigator.push(context,  MaterialPageRoute(builder: (context) => BuildingAlarmAndSecured()));
                    }
                  },
                ),
              ),
