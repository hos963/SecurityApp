...
class WindowandDoorScreen extends StatefulWidget {
  ...
  WindowandDoorScreen(this.addLockModel,this.callback);
...
class _WindowandDoorScreenState extends State<WindowandDoorScreen> {
  ...
  Future<void> Updatinngdata() async {
    ...
    widget.addLockModel.questionareModel.doorsAndWindowsSecured = istrue;

    FirebaseService firebaseService = new FirebaseService();
    await firebaseService.isWindowanddoorsecuredLock(
