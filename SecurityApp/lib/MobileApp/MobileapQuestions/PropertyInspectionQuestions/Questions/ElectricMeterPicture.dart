...
class ElectricMeterPicture extends StatefulWidget {

  final MyCallbackToback myCallbackToback;
  AddPropertyInspectionModel addPropertyInspectionModel;

  ElectricMeterPicture(this.addPropertyInspectionModel,this.myCallbackToback);

  @override
  _ElectricMeterPictureState createState() => _ElectricMeterPictureState();
}

class _ElectricMeterPictureState extends State<ElectricMeterPicture> {
  File _image;
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take electric meter picture", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    ElectricMeterPictureModel takeInternalPictures =
    new ElectricMeterPictureModel();
    takeInternalPictures.electricMeterPictureModel = ImgLinnk;
    widget.addPropertyInspectionModel.questionareModel.electricMeterPictureModel =
        takeInternalPictures;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.ElectricMeterPictureProperty(widget.addPropertyInspectionModel.inspectionId,
