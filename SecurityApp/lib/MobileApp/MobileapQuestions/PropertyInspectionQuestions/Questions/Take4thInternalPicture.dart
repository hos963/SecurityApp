...
class Take4thInternalPicture extends StatefulWidget {


  final MyCallbackToback myCallbackToback;
  AddPropertyInspectionModel addPropertyInspectionModel;

  Take4thInternalPicture(this.addPropertyInspectionModel,this.myCallbackToback);



  @override
  _Take4thInternalPictureState createState() => _Take4thInternalPictureState();
}

class _Take4thInternalPictureState extends State<Take4thInternalPicture> {
  File _image;
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                SizedBox(height: 20),
                text("Take 4th Internal Picture", textColor: quiz_textColorPrimary,
                    isLongText: true,
                    isCentered: true,
  ...
  Future<void> Updatinngdata(String ImgLinnk) async {
    ...
    Take4thInternalPictureModel takeInternalPictures =
    new Take4thInternalPictureModel();
    takeInternalPictures.take4thInternalPictureModel = ImgLinnk;
    widget.addPropertyInspectionModel.questionareModel.take4thInternalPictureModel =
        takeInternalPictures;

    // widget.addAlarmModel.questionareModel.onwayModel = onwayModel;

    await firebaseService.Take4thInternalPicturesModel(widget.addPropertyInspectionModel.inspectionId,
