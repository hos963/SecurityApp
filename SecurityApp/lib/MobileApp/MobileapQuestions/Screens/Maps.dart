...
class _MyHomePageState extends State<MyHomePage> {
  ...
  var myLatlng = new GeoCoord(30.2669444, -97.7427778);
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            GestureDetector(
              onTap: () {
                Navigator.of(context).pop(myLatlng.latitude.toString()+","+myLatlng.longitude.toString());
              },
              child: Icon(
                Icons.save,
          ...
          children: <Widget>[
            Positioned.fill(
              child: GoogleMap(
                ...
                initialZoom: 12,
                initialPosition: myLatlng,
                // Los Angeles, CA
                mapType: MapType.roadmap,
                mapStyle: _mapStyle,
                interactive: true,
                onTap: (coord) {
                  GoogleMap.of(_key).removeMarker(myLatlng);
                  myLatlng = coord;
                  ...
                  return _scaffoldKey.currentState.showSnackBar(SnackBar(
                    content: Text(myLatlng?.toString()),
