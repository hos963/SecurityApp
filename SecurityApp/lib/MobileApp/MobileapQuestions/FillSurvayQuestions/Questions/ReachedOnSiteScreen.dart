...
class ReachedOnSiteScreen extends StatefulWidget {

  final MyCallbackToback callback;
  AddAlarmModel addAlarmModel;
  ReachedOnSiteScreen(this.addAlarmModel,this.callback);
  @override
  _ReachedOnSiteScreenState createState() => _ReachedOnSiteScreenState();
}

class _ReachedOnSiteScreenState extends State<ReachedOnSiteScreen> {
  @override
  ...
  Future<void> Updatinngdata() async {
    ...
    widget.addAlarmModel.questionareModel.reachedonSiteModel = reachedonSiteModel;

    FirebaseService firebaseService = new FirebaseService();
    await firebaseService.ReachedOnSiteUpdate( widget.addAlarmModel.alarmId,widget.addAlarmModel.questionareModel);
